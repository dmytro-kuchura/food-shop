...
@section('description', $category->description ?? null)
@section('keywords', $category->keywords ?? null)
                                ...
                                <div class="row">
                                    @foreach($result as $item)
                                        <div class="col-xl-3 col-lg-4 col-md-4 col-6 item-width mb-30">
                                            <div class="product-item {{ $item->available ? '' : 'sold-out' }}">
                                                @if($item->sale)
                                                    <div class="main-label sale-label"><span>Розпродаж</span></div>
                                                @endif
                                                @if($item->new)
