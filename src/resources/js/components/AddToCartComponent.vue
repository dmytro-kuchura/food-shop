                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-9 col-lg-8 col-md-8 col-sm-9">
                            <div class="custom-qty">
                                <button v-on:click="onDecrement" class="reduced items" type="button"><i
                                    class="fa fa-minus"></i></button>
                                <input type="text" v-model="item.count" class="input-text qty">
                                <button v-on:click="onIncrement" class="increase items" type="button"><i
        ...
        <div class="bottom-detail cart-button">
            <ul>
                <li class="pro-cart-icon">
                    <button v-on:click="onSubmit" class="btn-color"><i class="fa fa-shopping-basket"></i> До кошику</button>
                </li>
                <li class="pro-wishlist-icon">
                    <a href="javascript:void(0)"><span><i class="fa fa-heart"></i></span>До обраного</a>
                </li>
            </ul>
        </div>
    </div>
